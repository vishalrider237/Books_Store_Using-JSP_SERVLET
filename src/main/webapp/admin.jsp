          ...
          <div class="col-md-4">
              <div class="card">
                  <div class="card-body text-center">
                      ...
                      <h1><%=list.size()%></h1>
                      <h1 class="text-uppercase text-muted">Books Categories</h1>
                  </div>
              </div>
          ...
          <div class="col-md-6">
              <div class="card" data-toggle="modal" data-target="#category-Modal">
                  <div class="card-body text-center">
                      ...
                      <p class="mt-2">Click here to add new Books category</p>
                      <h1 class="text-uppercase text-muted">Add Books Category</h1>
                  </div>
              </div>
          ...
          <div class="col-md-6">
              <div class="card" data-toggle="modal" data-target="#product-Modal">
                  <div class="card-body text-center">
                      ...
                      <p class="mt-2">Click here to add new Books</p>
